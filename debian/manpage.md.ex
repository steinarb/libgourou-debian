% libgourou(SECTION) | User Commands
%
% "September 23 2024"
...
libgourou - program to do something

# SYNOPSIS

**libgourou** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**libgourou** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **libgourou** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**libgourou** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    libgourou. See **foo.conf**(5) for further details.
...
**libgourou** provides some return codes, that can be used in scripts:
